...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://product-configurator.api.gogemini.io';
    ...
    {
        $report  = 'PHP SDK (GeminiCommerce\ProductConfigurator) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://product-configurator.api.gogemini.io",
