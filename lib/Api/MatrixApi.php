...
class MatrixApi
{
     ...
     * @param  \GeminiCommerce\ProductConfigurator\Model\ProductConfiguratorCreateMatrixRequest $body body (required)
     ...
     * @param  \GeminiCommerce\ProductConfigurator\Model\ProductConfiguratorCreateMatrixRequest $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['productConfiguratorCreateMatrix'] to see the possible values for this operation
     *
     * @throws \GeminiCommerce\ProductConfigurator\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  \GeminiCommerce\ProductConfigurator\Model\ProductConfiguratorListMatricesRequest $body body (required)
     ...
     * @param  \GeminiCommerce\ProductConfigurator\Model\ProductConfiguratorListMatricesRequest $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['productConfiguratorListMatrices'] to see the possible values for this operation
     *
     * @throws \GeminiCommerce\ProductConfigurator\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $tenant_id tenant_id (required)
     * @param  string $matrix_id matrix_id (required)
     * @param  \GeminiCommerce\ProductConfigurator\Model\ProductConfiguratorUpdateMatrixRequest $body body (required)
     ...
     * @param  string $tenant_id (required)
     * @param  string $matrix_id (required)
     * @param  \GeminiCommerce\ProductConfigurator\Model\ProductConfiguratorUpdateMatrixRequest $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['productConfiguratorUpdateMatrix'] to see the possible values for this operation
     *
     * @throws \GeminiCommerce\ProductConfigurator\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
