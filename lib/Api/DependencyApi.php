...
/**
     ...
     * @param  \GeminiCommerce\ProductConfigurator\Model\ProductconfiguratordependencyCreateRequest $body body (required)
     ...
     * @return \GeminiCommerce\ProductConfigurator\Model\ProductconfiguratordependencyEntity|\GeminiCommerce\ProductConfigurator\Model\GooglerpcStatus|\GeminiCommerce\ProductConfigurator\Model\GooglerpcStatus|\GeminiCommerce\ProductConfigurator\Model\GooglerpcStatus|\GeminiCommerce\ProductConfigurator\Model\GooglerpcStatus
     */
     ...
     * @param  \GeminiCommerce\ProductConfigurator\Model\ProductconfiguratordependencyCreateRequest $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['productConfiguratorCreateDependency'] to see the possible values for this operation
     *
     * @throws \GeminiCommerce\ProductConfigurator\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \GeminiCommerce\ProductConfigurator\Model\ProductconfiguratordependencyEntity|\GeminiCommerce\ProductConfigurator\Model\GooglerpcStatus|\GeminiCommerce\ProductConfigurator\Model\GooglerpcStatus|\GeminiCommerce\ProductConfigurator\Model\GooglerpcStatus|\GeminiCommerce\ProductConfigurator\Model\GooglerpcStatus, HTTP status code, HTTP response headers (array of strings)
     */
    public function productConfiguratorCreateDependencyWithHttpInfo($tenant_id, $step_id, $body, string $contentType = self::contentTypes['productConfiguratorCreateDependency'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\GeminiCommerce\ProductConfigurator\Model\ProductconfiguratordependencyEntity' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\GeminiCommerce\ProductConfigurator\Model\ProductconfiguratordependencyEntity' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\GeminiCommerce\ProductConfigurator\Model\ProductconfiguratordependencyEntity', []),
            ...
            $returnType = '\GeminiCommerce\ProductConfigurator\Model\ProductconfiguratordependencyEntity';
     ...
     * @param  \GeminiCommerce\ProductConfigurator\Model\DependencyListDependenciesRequest $body body (required)
     ...
     * @throws \GeminiCommerce\ProductConfigurator\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \GeminiCommerce\ProductConfigurator\Model\DependencyListDependenciesResponse|\GeminiCommerce\ProductConfigurator\Model\GooglerpcStatus|\GeminiCommerce\ProductConfigurator\Model\GooglerpcStatus|\GeminiCommerce\ProductConfigurator\Model\GooglerpcStatus|\GeminiCommerce\ProductConfigurator\Model\GooglerpcStatus
     */
     ...
     * @param  \GeminiCommerce\ProductConfigurator\Model\DependencyListDependenciesRequest $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['productConfiguratorListDependencies'] to see the possible values for this operation
     *
     * @throws \GeminiCommerce\ProductConfigurator\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \GeminiCommerce\ProductConfigurator\Model\DependencyListDependenciesResponse|\GeminiCommerce\ProductConfigurator\Model\GooglerpcStatus|\GeminiCommerce\ProductConfigurator\Model\GooglerpcStatus|\GeminiCommerce\ProductConfigurator\Model\GooglerpcStatus|\GeminiCommerce\ProductConfigurator\Model\GooglerpcStatus, HTTP status code, HTTP response headers (array of strings)
     */
    public function productConfiguratorListDependenciesWithHttpInfo($tenant_id, $page_size, $body, string $contentType = self::contentTypes['productConfiguratorListDependencies'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\GeminiCommerce\ProductConfigurator\Model\DependencyListDependenciesResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\GeminiCommerce\ProductConfigurator\Model\DependencyListDependenciesResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\GeminiCommerce\ProductConfigurator\Model\DependencyListDependenciesResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\GeminiCommerce\ProductConfigurator\Model\DependencyListDependenciesResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @param  string $tenant_id tenant_id (required)
     * @param  string $dependency_id dependency_id (required)
     * @param  \GeminiCommerce\ProductConfigurator\Model\ProductconfiguratordependencyUpdateRequest $body body (required)
     ...
     * @param  string $tenant_id (required)
     * @param  string $dependency_id (required)
     * @param  \GeminiCommerce\ProductConfigurator\Model\ProductconfiguratordependencyUpdateRequest $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['productConfiguratorUpdateDependency'] to see the possible values for this operation
     *
     * @throws \GeminiCommerce\ProductConfigurator\ApiException on non-2xx response
     * @throws \InvalidArgumentException
