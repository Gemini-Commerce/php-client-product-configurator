...
class DependencyApi
{
     ...
     * @param  \GeminiCommerce\ProductConfigurator\Model\ProductConfiguratorCreateDependencyRequest $body body (required)
     ...
     * @param  \GeminiCommerce\ProductConfigurator\Model\ProductConfiguratorCreateDependencyRequest $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['productConfiguratorCreateDependency'] to see the possible values for this operation
     *
     * @throws \GeminiCommerce\ProductConfigurator\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  \GeminiCommerce\ProductConfigurator\Model\ProductConfiguratorListDependenciesRequest $body body (required)
     ...
     * @param  \GeminiCommerce\ProductConfigurator\Model\ProductConfiguratorListDependenciesRequest $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['productConfiguratorListDependencies'] to see the possible values for this operation
     *
     * @throws \GeminiCommerce\ProductConfigurator\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $tenant_id tenant_id (required)
     * @param  string $dependency_id dependency_id (required)
     * @param  \GeminiCommerce\ProductConfigurator\Model\ProductConfiguratorUpdateDependencyRequest $body body (required)
     ...
     * @param  string $tenant_id (required)
     * @param  string $dependency_id (required)
     * @param  \GeminiCommerce\ProductConfigurator\Model\ProductConfiguratorUpdateDependencyRequest $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['productConfiguratorUpdateDependency'] to see the possible values for this operation
     *
     * @throws \GeminiCommerce\ProductConfigurator\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
