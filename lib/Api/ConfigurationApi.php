...
/**
     ...
     * @param  string $tenant_id tenant_id (required)
     * @param  string $product_id product_id (required)
     * @param  \GeminiCommerce\ProductConfigurator\Model\ConfigurationGetAvailableConfigurationRequest $body body (required)
     ...
     * @param  string $tenant_id (required)
     * @param  string $product_id (required)
     * @param  \GeminiCommerce\ProductConfigurator\Model\ConfigurationGetAvailableConfigurationRequest $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['productConfiguratorGetAvailableConfiguration2'] to see the possible values for this operation
     *
     * @throws \GeminiCommerce\ProductConfigurator\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @param  string $tenant_id tenant_id (required)
     * @param  string $product_id product_id (required)
     * @param  \GeminiCommerce\ProductConfigurator\Model\ConfigurationGetConfigurationFromSelectionsRequest $body body (required)
     ...
     * @param  string $tenant_id (required)
     * @param  string $product_id (required)
     * @param  \GeminiCommerce\ProductConfigurator\Model\ConfigurationGetConfigurationFromSelectionsRequest $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['productConfiguratorGetConfigurationFromSelections'] to see the possible values for this operation
     *
     * @throws \GeminiCommerce\ProductConfigurator\ApiException on non-2xx response
     * @throws \InvalidArgumentException
