...
/**
     ...
     * @param  \GeminiCommerce\ProductConfigurator\Model\ProductconfiguratorstepBulkCreateRequest $body body (required)
     ...
     * @param  \GeminiCommerce\ProductConfigurator\Model\ProductconfiguratorstepBulkCreateRequest $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['productConfiguratorBulkCreateSteps'] to see the possible values for this operation
     *
     * @throws \GeminiCommerce\ProductConfigurator\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  string $tenant_id tenant_id (required)
     * @param  \GeminiCommerce\ProductConfigurator\Model\ProductconfiguratorstepBulkDeleteRequest $body body (required)
     ...
     *
     * @param  string $tenant_id (required)
     * @param  \GeminiCommerce\ProductConfigurator\Model\ProductconfiguratorstepBulkDeleteRequest $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['productConfiguratorBulkDeleteSteps'] to see the possible values for this operation
     *
     * @throws \GeminiCommerce\ProductConfigurator\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @param  \GeminiCommerce\ProductConfigurator\Model\ProductconfiguratorstepCopyRequest $body body (required)
     ...
     * @param  \GeminiCommerce\ProductConfigurator\Model\ProductconfiguratorstepCopyRequest $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['productConfiguratorCopyStep'] to see the possible values for this operation
     *
     * @throws \GeminiCommerce\ProductConfigurator\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @param  string $tenant_id tenant_id (required)
     * @param  string $configurator_id configurator_id (required)
     * @param  \GeminiCommerce\ProductConfigurator\Model\ProductconfiguratorstepCreateRequest $body body (required)
     ...
     * @param  string $tenant_id (required)
     * @param  string $configurator_id (required)
     * @param  \GeminiCommerce\ProductConfigurator\Model\ProductconfiguratorstepCreateRequest $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['productConfiguratorCreateStep'] to see the possible values for this operation
     *
     * @throws \GeminiCommerce\ProductConfigurator\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @param  string $tenant_id tenant_id (required)
     * @param  string $step_id step_id (required)
     * @param  \GeminiCommerce\ProductConfigurator\Model\ProductconfiguratorstepUpdateRequest $body body (required)
     ...
     * @param  string $tenant_id (required)
     * @param  string $step_id (required)
     * @param  \GeminiCommerce\ProductConfigurator\Model\ProductconfiguratorstepUpdateRequest $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['productConfiguratorUpdateStep'] to see the possible values for this operation
     *
     * @throws \GeminiCommerce\ProductConfigurator\ApiException on non-2xx response
     * @throws \InvalidArgumentException
