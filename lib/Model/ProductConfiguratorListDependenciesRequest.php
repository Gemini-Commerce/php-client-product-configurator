...
/**
 * ProductConfiguratorListDependenciesRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ProductConfiguratorListDependenciesRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductConfigurator_ListDependencies_request';
    ...
    {
        $this->setIfExists('step_ids', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['step_ids'];
    }

    /**
     * Sets step_ids
     *
     * @param string[]|null $step_ids step_ids
     *
     * @return self
     */
    public function setStepIds($step_ids)
    {
        if (is_null($step_ids)) {
            throw new \InvalidArgumentException('non-nullable step_ids cannot be null');
        }
        $this->container['step_ids'] = $step_ids;
