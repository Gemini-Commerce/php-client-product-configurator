...
/**
 * ProductconfiguratormatrixUpdatePayload Class Doc Comment
 *
 * @category Class
 * @package  GeminiCommerce\ProductConfigurator
 * @author   OpenAPI Generator team
 ...
 */
class ProductconfiguratormatrixUpdatePayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'productconfiguratormatrixUpdatePayload';
    ...
    */
     ...
     *
     * @param string|null $default_property_id default_property_id is the id of the property that will be used as the starting point to calculate the differences between the properties.
     *
     * @return self
     */
     ...
     * Sets steps
     *
     * @param \GeminiCommerce\ProductConfigurator\Model\ProductconfiguratormatrixStep[]|null $steps steps are the same as in the create request. This is a full replacement.
     *
     * @return self
     */
